...
const Cart = () => {
  ...
  // --- PROBLEM WAS HERE ---
  // The useEffect dependency array was [Cart], causing an infinite loop.
  // It has been changed to [] to run only once.
  useEffect(() => {
    if (isLoggedIn === false) {
      navigate("/");
    } else {
  ...
  }, [isLoggedIn, navigate]); // Now depends on isLoggedIn and navigate
  ...
  return (
    <div className="min-h-screen bg-zinc-900 px-4 sm:px-12 py-8">
      {!Cart && <Loader />}
      {Cart && Cart.length === 0 && (
        ...
        <div className="mt-4 w-full flex items-center justify-end">
          <div className="p-4 bg-zinc-800 rounded">
            ...
            <div className="w-full mt-3">
              <button
                className="bg-zinc-100 rounded px-4 py-2 flex justify-center w-full font-semibold hover:bg-zinc-200 text-black"
                onClick={PlaceOrder}
              >
                Place your order
              </button>
